...
export default function PortfolioCard() {
  return (
    <>
      {/* <Navbar /> */}
      <div id="about" className="text-black p-4 flex flex-col items-center mt-64">
        <div className="flex flex-col md:flex-row items-center bg-[#C890A7] p-6 rounded-2xl shadow-lg max-w-4xl w-full">
          ...
          <div className="flex-1 text-center md:text-left">
            <h1 className="text-4xl font-bold text-[#212121]">
              Hello, I&apos;m <span className="text-white">Zaima.</span>
            </h1>
            ...
            <div className="mt-4 flex items-center space-x-4">
              <a
                ...
                className="bg-[#A35C7A] px-4 py-2 rounded-full text-white font-semibold flex items-center"
              >
