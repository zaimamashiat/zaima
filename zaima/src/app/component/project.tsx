...
export default function ProjectGrid() {
  const projects = [
    { title: "Fitness Matrix", link: "https://github.com/zaimamashiat/fitness_matrix", description: "A fitness tracking application.", image: "/fit.jpg" },
    ...
    { title: "Medi Connect", link: "https://github.com/zaimamashiat/Final-MediConnect-Project-CSE370", description: "A healthcare service platform.", image: "/medi.jpg" },
